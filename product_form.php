...
<form action="product_register.php" method="POST"  enctype="multipart/form-data" style="display:inline-block" ">
...
<div class="recipe_regi">
    ...
    <div class="cont_box pad_l_60">
	  ...
	  <!-- 이름, 원산지, 가격, 설명, 포스터이미지, 배송기간, 배송비, 할인율, 등록일 -->
      <div class="cont_line">
		<p class="cont_tit4">상품 이름</p>
		<input type="text" id="cok_title" name ="product_name" class="form-control" style="width:610px; ">
	  </div>
      <div class="cont_line pad_b_25">
		<p class="cont_tit4">원산지</p>
		<textarea id="cok_intro" name = "product_origin" class="form-control step_cont" style="width:610px; resize:none;"></textarea>
      </div>
      <div class="cont_line pad_b_25">
		<p class="cont_tit4">가격</p>
		<textarea id="cok_intro" name = "product_price" class="form-control step_cont" style="width:610px; resize:none;"></textarea>
      </div>      
	  <div class="cont_line pad_b_25">
		<p class="cont_tit4">상품 설명</p>
		<textarea id="cok_intro" name = "product_notice" class="form-control step_cont" style="height:100px; width:610px; resize:none;"></textarea>
      </div>      
	  <div class="cont_line pad_b_25">
		<p class="cont_tit4">배송기간</p>
		<textarea id="cok_intro"name = "product_delivery" class="form-control step_cont" style="width:610px; resize:none;"></textarea>
      </div>
	  <div class="cont_line pad_b_25">
		<p class="cont_tit4">배송비</p>
		<textarea id="cok_intro" name = "product_fee" class="form-control step_cont" style="width:610px; resize:none;"></textarea>
      </div>	
	  <div class="cont_line pad_b_25" style="float:left;">
	  <!--이미지 업로드-->
			<div style = "width : 500px; float:left;">
				<p class="cont_tit4">포스터</p>
					<div id="divStepPhotoBox_1" is_over="0">
								<label for="mainImg1">
									...
									<input type="file" id="mainImg1" name="product_poster" accept=".png, .jpg" style="width: 0; height : 0 ; overflow : hidden;"> 
										<script type="text/javascript">
				...
				<p class="cont_tit4">상세정보</p>
					<div id="divStepPhotoBox_1" is_over="0">
								<label for="mainImg2">
									<img id="mainPreview2" src="https://recipe1.ezmember.co.kr/img/pic_none2.gif" style="width : 160px; height : 160px;">
								</label>
									<input type="file" id="mainImg2" name="product_poster2" accept=".png, .jpg" style="width: 0; height : 0 ; overflow : hidden;"> 
										<script type="text/javascript">
	  ...
	  <div class="cont_line pad_b_25">
		<p class="cont_tit4">할인율</p>
		<textarea id="cok_intro" name = "product_sale" class="form-control step_cont" style="width:610px; resize:none;"></textarea>
      </div>
