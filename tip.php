...
<body>
    <div class="board_wrap">
        <div class="board_title">
            <strong>팁과 노하우</strong>
            <br>
            
            
         <div class="recipe">
        <div class="b-sel-box b-cate-basic">
        <a href="free.php"><button type="submit" class="b-sel-btn" style="font-weight:bold;">자유 게시판</button></a>
        <a href="question.php"><button type="submit" class="b-sel-btn" style="font-weight:bold;" >질문 게시판</button></a>
        <a href="tip.php"><button type="submit" class="b-sel-btn" style="font-weight:bold; background-color:#FF9D2D;color:#fff; ">팁과 노하우</button></a>
         </div>
         </div>
        <br>
...
?>
                <div>
                    ...
                    ?>
                    <div class="title"><a href="t_view.php?num=<?=$Board_id?> "><?=$row['board_info_title']?>&nbsp; [<?=$numRecords?>]</a></div>
                    <div class="writer"><?=$row['board_info_writer']?></div>
...
?>      
     ...
     <a href="tip.php?page=1" title="처음 페이지로 이동하기"><img src="img/btn-first-page.gif"></a>
     </li>
     <li class="prev pager">
     <a href="tip.php?page=<?=$firstLink - $numLinks?>" title="이전 페이지로 이동하기"><img src="img/btn-prev-page.gif"></a>
     </li>
...
?>
     ...
     <li><a href="tip.php?page=<?=$i?>" <?=($i == $page) ? "class='active'" : $i?> ><?=($i == $page) ? "$i" : $i?></a></li>
...
?>
<li class="next pager">
<a href="tip.php?page=<?=$firstLink + $numLinks?>" title="다음 페이지로 이동하기"><img src="img/btn-next-page.gif"></a>
</li>
<li class="last pager">
<a href="tip.php?page=<?=$numPage ?>" title="마지막 페이지로 이동하기"><img src="img/btn-last-page.gif"></a>
</li>
<?php
}
?>
    ...
    <div class="bt_wrap" style="margin-left:890px;">
                <a href="t_write.php" class="on" style="border:none;">글쓰기</a>
                <!--<a href="#">수정</a>-->
            </div>
<br><br><br>
       <!--footer-->
