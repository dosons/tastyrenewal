...
<body>
    <div class="board_wrap">
        ...
        <a href="q_my_community.php"><button type="submit" class="b-sel-btn" style="font-weight:bold;" >질문 게시판</button></a>
        <a href="t_my_community.php"><button type="submit" class="b-sel-btn" style="font-weight:bold; background-color:#FF9D2D;color:#fff">팁과 노하우</button></a>
         </div>
         </div>
        <br>
...
?>      
     ...
     <a href="t_my_community.php?page=1" title="처음 페이지로 이동하기"><img src="img/btn-first-page.gif"></a>
     </li>
     <li class="prev pager">
     <a href="t_my_community.php?page=<?=$firstLink - $numLinks?>" title="이전 페이지로 이동하기"><img src="img/btn-prev-page.gif"></a>
     </li>
...
?>
     ...
     <li><a href="t_my_community.php?page=<?=$i?>" <?=($i == $page) ? "class='active'" : $i?> ><?=($i == $page) ? "$i" : $i?></a></li>
...
?>
<li class="next pager">
<a href="t_my_community.php?page=<?=$firstLink + $numLinks?>" title="다음 페이지로 이동하기"><img src="img/btn-next-page.gif"></a>
</li>
<li class="last pager">
<a href="t_my_community.php?page=<?=$numPage ?>" title="마지막 페이지로 이동하기"><img src="img/btn-last-page.gif"></a>
</li>
<?php
}
?>
