...
?>
         <li class="cell" style="width : 250px; margin:30px ">
            ...
            <div class="product-price"><?=$row['store_product_price']?>원</div>
            <div class="product-week"><?=substr($row['store_info_name'],0,16)?></div>
        </li>
<?php
       }
?>
