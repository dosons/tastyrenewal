...
?>           
       ...
       <body>
        ...
        <div id="btn1">
            <a href="my_recipe_write.php"> 내가 쓴 레시피</a>
        </div>
		 <div id="btn1">
            <a href="buy_list.php?num=<?= $m_num?>">내 구매목록</a>
        </div>
		<div id="btn1">
            <a href="buy_cart.php?num=<?= $m_num?>">찜 목록</a>
        </div>
        <div id="btn2">
            <a href="my_community.php"> 내가 쓴 게시글 </a>
        </div>
        <div id="btn3">
            <a href="myalter.php"> 회원정보수정 </a>
        </div>
		<?php
		if(empty($num)){
		?>
		<div id="btn4">
            <a href="enroll_store.php"> 점주등록 </a>
        </div>
		<?php
		}
		?>
