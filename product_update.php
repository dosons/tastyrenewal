...
<form action="product_change.php?num=<?=$p_num?>" method="POST"  enctype="multipart/form-data" style="display:inline-block" ">
...
<div class="recipe_regi">
    ...
    <!-- 필수재료 추가 -->
	  <div class="regi_btm">
			<input  type="submit" id="input" value="수정"  class="btn-lg btn-primary" ></button>
