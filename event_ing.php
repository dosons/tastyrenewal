...
<head>
    ...
    <link rel="stylesheet" href="css/event_ing.css">
    <!--font-->
...
<?php
     ...
     <nav>
      ...
      <li style="color:#FF9D2D" > <a href="event_ing.php">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp진행중인 이벤트&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a></li>
      <li> <a href="event_end.php">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp종료된 이벤트&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a></li>
