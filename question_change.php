...
if ($title== null){
	echo"<script>alert('게시글 제목을 입력해주세요.'); location.href=('question_update.php?num=$num');</script>";
	return;
}

if ($content == null){
	echo"<script>alert('내용을 입력해주세요.'); location.href=('question_update.php?num=$num');</script>";
	return;
}
...
$curTime = date("Y-m-d H:i:s");
 ...
 echo "<script>alert('게시글이 수정되었습니다.'); location.href=('q_view.php?num=$num ');</script>";