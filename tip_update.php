...
?>
        ...
        <form method="POST" action="tip_change.php?num=<?=$num?>" enctype="multipart/form-data">
            ...
            <div class="board_write">
                ...
                <div class="info">
                    ...
                    <dl>
                        ...
                        <dt>파일첨부</dt>
                        <dd><h style="Color:red;"><?=$free_file?></h><br><input id="file-input" type="file" name="free_file">
                            </dd>
                    </dl>
                </div>
                <div class="cont">
      ...
      <ul class="b-btn-wrap">
      <li>
      <a class="b-btn-type01" href="t_view.php?num=<?=$num?>">취소</a>
      </li>
      <li>
