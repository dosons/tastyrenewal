...
<form action="q_reply_register.php?num=<?=$Board_id?>" method="POST">
            <div id="comment_box">
...
?>
                <a href="question.php" class="on" style="border:none;">목록</a>
                <a href="question_update.php?num=<?=$Board_id?>">수정</a>
                <a href="question_delete.php?num=<?=$Board_id?>">삭제</a>
<?php
      } else {
