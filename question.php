...
<body>
    <div class="board_wrap">
        ...
        <a href="question.php"><button type="submit" class="b-sel-btn" style="font-weight:bold;background-color:#FF9D2D;color:#fff" >질문 게시판</button></a>
        <a href="tip.php"><button type="submit" class="b-sel-btn" style="font-weight:bold; ">팁과 노하우</button></a>
         </div>
         </div>
        <br>
...
$query = $db->query("SELECT *,
				...
				FROM board_info AS a where a.board_info_type = '$type'
...
?>      
     ...
     <a href="question.php?page=1" title="처음 페이지로 이동하기"><img src="img/btn-first-page.gif"></a>
     </li>
     <li class="prev pager">
     <a href="question.php?page=<?=$firstLink - $numLinks?>" title="이전 페이지로 이동하기"><img src="img/btn-prev-page.gif"></a>
     </li>
...
?>
     ...
     <li><a href="question.php?page=<?=$i?>" <?=($i == $page) ? "class='active'" : $i?> ><?=($i == $page) ? "$i" : $i?></a></li>
...
?>
<li class="next pager">
<a href="question.php?page=<?=$firstLink + $numLinks?>" title="다음 페이지로 이동하기"><img src="img/btn-next-page.gif"></a>
</li>
<li class="last pager">
<a href="question.php?page=<?=$numPage ?>" title="마지막 페이지로 이동하기"><img src="img/btn-last-page.gif"></a>
</li>
<?php
}
?>
