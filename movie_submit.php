...
<form action="movie_register.php" method="POST" enctype="multipart/form-data" style="display:inline-block">
...
<div class="recipe_regi">
    ...
    <div class="regi_title" >레시피 영상 등록
    ...
    <div class="cont_box pad_l_60">
      <div id="divMainPhotoUpload" class="cont_pic2">
        ...
        <div style="position:absolute;left:-3000px"><input type="file" name="q_main_file" id="q_main_file" file_gubun="main" accept="jpeg,png,gif" style="width:0px;height:0px;font-size:0px;" text=""></div>
        <!-- 썸네일 이미지 -->
	  <div id="divStepItem_1">
			<label for="mainImg7">
                <img id="cok_video_url" src="img/movie_preview.PNG" style="width : 300px; height : 300px; border-radius:30px;">
             </label>
      ...
      <div class="cont_line pad_b_25"><p class="cont_tit4">동영상</p>
		  <textarea name="movie_url" id="cok_video_url" class="form-control step_cont youtube-url" placeholder="동영상이 있으면 주소를 입력하세요.(Youtube만 가능) 예)http://youtu.be/lA0Bxo3IZmM" style="height:100px; width:526px; resize:none;"></textarea>
          <button type="button" id="getBtn" class="thum_btn" style="background:#333; color: white; outline: none; height: 100px; border-radius: 6px; cursor: pointer;">
          썸네일 미리보기
          </button>
...
const thumbnailImg= document.querySelector("#cok_video_url");
...
function getThum() {
   ...
   thumArr.forEach(thum => {
      thumbnailImg.setAttribute("src", `https://img.youtube.com/vi/${thum}/mqdefault.jpg`)
   });
};
</script>

            <div style="position:absolute;left:-3000px">
          <input type="file" name="q_video_file" id="q_video_file" file_gubun="video" accept="jpeg,png,gif" style="width:0px;height:0px;font-size:0px;" text="">
          </div>
      </div>
    ...
    <div class="cont_box pad_l_60">
			...
			<li id="liMaterialGroup_1">
				...
				<ul id="divMaterialArea_1" class="ui-sortable">
					...
					<li id="liMaterial_1_3">
						...
						<input type="text" name="messen_name_1" id="cok_material_nm_1_3" class="form-control" style="width:330px;" placeholder="예) 참기름">
						<input type="text" name="movie_essen_num_1" id="cok_material_amt_1_3" class="form-control" style="width:280px;" placeholder="예) 1T">
					...
					<li id="liMaterial_1_4">
						...
						<input type="text" name="messen_name_2" id="cok_material_nm_1_4" class="form-control" style="width:330px;" placeholder="예) 소금">
                        <input type="text" name="movie_essen_num_2" id="cok_material_amt_1_4" class="form-control" style="width:280px;" placeholder="예) 2t">
						<a id="btnMaterialDel_1_4" href="javascript:delMaterial(1,4)" class="btn-del" style="display: none;"></a>
					</li>
					<li id="liMaterial_1_5">
						<a href="#" class="btn-lineup"></a>
						<input type="text" name="messen_name_3" id="cok_material_nm_1_5" class="form-control" style="width:330px;" placeholder="예) 고추가루 약간">
						<input type="text" name="movie_essen_num_3" id="cok_material_amt_1_5" class="form-control" style="width:280px;" placeholder="예) ">
					...
					<li id="liMaterial_1_6"><a href="#" class="btn-lineup"></a>
						<input type="text" name="messen_name_4" id="cok_material_nm_1_6" class="form-control" style="width:330px;" placeholder="예) 돼지고기">
						<input type="text" name="movie_essen_num_4" id="cok_material_amt_1_6" class="form-control" style="width:280px;" placeholder="예) 300g">
	  ...
	  <div class="regi_btm">
        ...
        <button type="button" onclick="location.href='recipe_movie.php';" class="btn-lg btn-default">취소</button>
      </div>
</div><!-- /container --></form>
</div>
 </form>
